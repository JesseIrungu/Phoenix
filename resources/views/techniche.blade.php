...
/* On small screens (mobile devices), stack the elements vertically */
   ...
   <nav class="fixed top-0 left-0 w-full relative container mx-auto p-6">
        ...
        <div class="md:hidden">
            <div id="menu" class="absolute flex flex-col items-center self-end  py-8 mt-10 space-y-6 font-bold
             ...
             <a href="#contactus" class="menu-btn">Contact Us</a>            
            </div>
        </div>
    </nav>    
    <!--heroo section-->
    ...
    <h1><span>Creative and Innovative Solutions</span></h1>
                ...
                We are a dynamic ICT company that specializes in providing top-notch services, including website and mobile app development, software installations, and computer servicing and repairs.
      ...
      <div class=" px-5 mx-auto mt-32 text-center">
        ...
        <div class="flex flex-col  md:flex-row md:space-x-6 md:mt-24">
            ...
            <div class="md:flex flex-col items-center p-6 space-y-6 rounded-lg md:w-1/3">
                <div class="rounded overflow-hidden">
                  <figure class="image is-128x128 mx-auto">
                    <img class="is-rounded" src="{{URL::asset('/tailwind/image/linus.jpeg')}}">
                  </figure>
                  <br><br><br>
            ...
            <div class="md:flex flex-col items-center p-6 space-y-6 rounded-lg  md:w-1/3">
                <div class=" rounded overflow-hidden ">
                  <figure class="image is-128x128 mx-auto">
                    <img class="is-rounded" src="{{URL::asset('/tailwind/image/sharon.png')}}">
                  </figure>
                  <br><br><br>
...
@endif
  ...
  <div class="container flex justify-between items-center px-6 py-10 mx-auto">
    ...
    <div class="text-white flex flex-col space-y-3 md:items-end">
      <p style="color: blue;">Contact info</p>
      <p>Kimathi Street, Nairobi</p>
      <p>+254 743 784 792</p>
      <p>+254 748 174 004</p>
      <p>info@technichesolutions.co.ke</p>
    </div>
  </div>
