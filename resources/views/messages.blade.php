...
<body>
  <div class="container-fluid">
    <nav class="navbar navbar-expand-lg fixed-top bg-info">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" href="registration"><i class="fa-solid fas fa-envelope-open"><strong></i>Make Request</strong></a>
        </li>
        <li class="nav-item">
  ...
  <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4" style="margin: 10px 40px 15px 14px;">
                <h4>Customers' Requests</h4>
                <hr>

                @csrf
                 
                    @if(Session::has('enquiry_delete'))
                    <div class="alert alert-success">{{Session::get('enquiry_delete')}}</div>
                    @endif
